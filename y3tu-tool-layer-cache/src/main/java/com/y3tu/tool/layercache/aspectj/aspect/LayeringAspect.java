package com.y3tu.tool.layercache.aspectj.aspect;

import com.y3tu.tool.layercache.aspectj.annotation.*;
import com.y3tu.tool.layercache.aspectj.expression.CacheOperationExpressionEvaluator;
import com.y3tu.tool.layercache.aspectj.support.CacheOperationInvoker;
import com.y3tu.tool.layercache.aspectj.support.KeyGenerator;
import com.y3tu.tool.layercache.aspectj.support.SimpleKeyGenerator;
...
public class LayeringAspect {
    ...
    @Pointcut("@annotation(com.y3tu.tool.layercache.aspectj.annotation.Cacheable)")
    public void cacheablePointcut() {
    }

    @Pointcut("@annotation(com.y3tu.tool.layercache.aspectj.annotation.CacheEvict)")
    public void cacheEvictPointcut() {
    }

    @Pointcut("@annotation(com.y3tu.tool.layercache.aspectj.annotation.CachePut)")
