...
import com.y3tu.tool.db.handler.NumberHandler;
import com.y3tu.tool.db.handler.PageResultHandler;
import com.y3tu.tool.db.handler.RsHandler;
...
public class SqlConnRunner{
	...
	public <T> T find(Connection conn, Entity where, RsHandler<T> rsh, String... fields) throws SQLException {
		return find(conn, ListUtil.newArrayList(fields), where, rsh);
	}
