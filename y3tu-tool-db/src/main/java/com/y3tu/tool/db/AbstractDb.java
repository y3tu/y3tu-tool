...
import com.y3tu.tool.db.handler.*;
...
public abstract class AbstractDb {
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> List<T> query(String sql, Class<T> beanClass, Object... params) {
    ...
    public <T> T query(String sql, RsHandler<T> rsh, Object... params) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! query()-> sql:{};param:{}", sql, ObjectUtil.toPrettyString(params));
        } finally {
     ...
     * @throws SQLException SQL执行异常
     */
    public Long executeForGeneratedKey(String sql, Object... params) {
        Connection conn = null;
        try {
            conn = this.getConnection();
            return SqlExecutor.executeForGeneratedKey(conn, sql, params);
        } catch (SQLException e) {
            throw new DbRuntimeException(e, "sql错误! executeForGeneratedKey()->sql:{};param:{}", sql, ObjectUtil.toPrettyString(params));
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public int[] executeBatch(String sql, Object[]... paramsBatch) {
        Connection conn = null;
        try {
            conn = this.getConnection();
            return SqlExecutor.executeBatch(conn, sql, paramsBatch);
        } catch (SQLException e) {
            throw new DbRuntimeException(e, "sql错误! executeBatch()-> sql:{};param:{}", sql, ObjectUtil.toPrettyString(paramsBatch));
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public int insert(Entity record) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! insert()->param:{}", ObjectUtil.toPrettyString(record));
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public int insertOrUpdate(Entity record, String... keys) {
        Connection conn = null;
        try {
            conn = this.getConnection();
            return runner.insertOrUpdate(conn, record, keys);
        } catch (SQLException e) {
            throw new DbRuntimeException(e, "sql错误! insertOrUpdate()");
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public int[] insert(Collection<Entity> records) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! insert()");
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Object> insertForGeneratedKeys(Entity record) {
        Connection conn = null;
        try {
            conn = this.getConnection();
            return runner.insertForGeneratedKeys(conn, record);
        } catch (SQLException e) {
            throw new DbRuntimeException(e, "sql错误! insertForGeneratedKeys()-> param:{}", ObjectUtil.toPrettyString(record));
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public Long insertForGeneratedKey(Entity record) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! insertForGeneratedKey()-> param:{}", ObjectUtil.toPrettyString(record));
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public int del(Entity where) throws SQLException {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! del()-> param:{}", ObjectUtil.toPrettyString(where));
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public int update(Entity record, Entity where) throws SQLException {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! update()-> param:{}", ObjectUtil.toPrettyString(record));
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T find(Collection<String> fields, Entity where, RsHandler<T> rsh) {
        Connection conn = null;
        try {
            conn = this.getConnection();
            return runner.find(conn, fields, where, rsh);
        } catch (SQLException e) {
            throw new DbRuntimeException(e, "sql错误! find()");
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T find(Query query, RsHandler<T> rsh) {
        Connection conn = null;
        try {
            conn = this.getConnection();
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T find(Entity where, RsHandler<T> rsh, String... fields) {
        return find(ListUtil.newArrayList(fields), where, rsh);
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> List<T> find(Entity where, Class<T> beanClass) {
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Entity> findAll(Entity where) {
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> List<T> findAll(Entity where, Class<T> beanClass) {
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Entity> findBy(String tableName, String field, Object value) {
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Entity> findBy(String tableName, Condition... wheres) {
    ...
    public int count(Entity where) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! count()");
        } finally {
            this.closeConnection(conn);
        }
    }
    ...
    public <T> T page(Collection<String> fields, Entity where, int page, int numPerPage, RsHandler<T> rsh) {
        ...
        try {
            ...
            throw new DbRuntimeException(e, "sql错误! page()");
        } finally {
            this.closeConnection(conn);
        }
    }
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T page(Entity where, int page, int numPerPage, RsHandler<T> rsh) {
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Entity> pageForEntityList(Entity where, int page, int numPerPage) {
     ...
     * @throws SQLException SQL执行异常
     */
    public List<Entity> pageForEntityList(Entity where, Page page) {
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T page(Entity where, Page page, RsHandler<T> rsh) {
     ...
     * @throws SQLException SQL执行异常
     */
    public <T> T page(Collection<String> fields, Entity where, Page page, RsHandler<T> rsh) {
        Connection conn = null;
        try {
            conn = this.getConnection();
     ...
     * @throws SQLException SQL执行异常
     */
    public PageResult<Entity> page(Entity where, int page, int numPerPage) {
