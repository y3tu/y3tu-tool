...
public abstract class DSFactory {
        ...
        if (null == setting) {
            try {
                ...
                try {
                    ...
                    throw new UtilException("Default db setting [{}] or [{}] in classpath not found !", DEFAULT_DB_SETTING_PATH, DEFAULT_DB_SETTING_PATH2);
                }
            }
        }
    ...
    public DataSource getDataSource() {
        return getDataSource(StringUtils.EMPTY);
    }
