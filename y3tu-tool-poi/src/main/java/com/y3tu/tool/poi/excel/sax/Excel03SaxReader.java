    ...
    public void processRecord(Record record) {
        ...
        if (record instanceof BoundSheetRecord) {
            ...
            if (record instanceof MissingCellDummyRecord) {
                ...
                rowCellList.add(mc.getColumn(), StringUtils.EMPTY);
    ...
    private void processCellValue(Record record) {
        ...
        switch (record.getSid()) {
            case BlankRecord.sid:
                ...
                rowCellList.add(brec.getColumn(), StringUtils.EMPTY);
                break;
            ...
            case LabelSSTRecord.sid: // 字符串类型
                ...
                if (sstRecord == null) {
                    rowCellList.add(lsrec.getColumn(), StringUtils.EMPTY);
                } else {
            ...
            case NumberRecord.sid: // 数字类型
                ...
                if (formatString.contains(StringUtils.DOT)) {
                    //浮点数
                    value = numrec.getValue();
                } else if (formatString.contains(StringUtils.SLASH) || formatString.contains(StringUtils.COLON)) {
                    //日期
