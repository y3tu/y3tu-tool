...
<script>
    ...
    import componentList from './component-lib/component-list' // 左侧列表数据
    ...
    export default {
        ...
        computed: {
            componentData() {
                return this.$store.state.visualDesign.componentData
            },
            curComponent() {
                return this.$store.state.visualDesign.curComponent
            },
            canvasStyleData() {
                return this.$store.state.visualDesign.canvasStyleData
            }
        },
        created() {
            // 用保存的数据恢复画布
