...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                componentData: state => state.visualDesign.componentData,
                curComponent: state => state.visualDesign.curComponent,
                canvasStyleData: state => state.visualDesign.canvasStyleData,
            })
        },
        methods: {
