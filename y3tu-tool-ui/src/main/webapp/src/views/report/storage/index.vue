<template>
    <div class="main-container">
        <div class="head-container">
            <label class="form-item-label">配置名称</label>
        ...
        <el-table
                ...
                style="width: 100%;">
            <el-table-column label="存储配置名称" prop="name" align="center" show-overflow-tooltip min-width="120px">
                <template #default="scope">
                    <span>{{ scope.row.name }}</span>
                </template>
            </el-table-column>
            <el-table-column label="存储类型" :show-overflow-tooltip="true" align="center" min-width="150px">
                <template #default="scope">
