...
import com.y3tu.tool.db.sql.SqlLog;
...
public final class DbUtil {
    ...
    public static void setShowSqlGlobal(Setting setting) {
        ...
        log.debug("Show sql: [{}], format sql: [{}], show params: [{}], level: [{}]", isShowSql, isFormatSql, isShowParams);
        setShowSqlGlobal(isShowSql, isFormatSql, isShowParams);
    }
    ...
    public static void setShowSqlGlobal(boolean isShowSql, boolean isFormatSql, boolean isShowParams) {
        SqlLog.INSTASNCE.init(isShowSql, isFormatSql, isShowParams);
    }
}
