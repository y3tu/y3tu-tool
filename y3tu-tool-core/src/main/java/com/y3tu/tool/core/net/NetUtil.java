...
public class NetUtil {
	...
	public static String toAbsoluteUrl(String absoluteBasePath, String relativePath) {
		try {
			...
			throw new NetException(e, "To absolute url [{}] base [{}] error!", relativePath, absoluteBasePath);
		}
	}
	...
	public static Collection<NetworkInterface> getNetworkInterfaces() {
		...
		return CollectionUtil.addAll(new ArrayList<NetworkInterface>(), networkInterfaces,null);
	}
	...
	public static LinkedHashSet<String> localIpv4s() {
		...
		if (networkInterfaces == null) {
			throw new NetException("Get network interface error!");
		}
