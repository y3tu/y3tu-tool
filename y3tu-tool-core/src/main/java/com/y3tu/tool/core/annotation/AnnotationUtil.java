...
public class AnnotationUtil {
    ...
    public static <T> T getAnnotationValue(AnnotatedElement annotationEle, Class<? extends Annotation> annotationType, String propertyName) throws AnnotationException {
        ...
        final Method method = ReflectionUtil.getMethodOfObj(annotationEle, propertyName);
        if (null == method) {
            return null;
        }
        return ReflectionUtil.invoke(annotationEle, method);
    }
    ...
    public static Map<String, Object> getAnnotationValueMap(AnnotatedElement annotationEle, Class<? extends Annotation> annotationType) throws AnnotationException {
        ...
        final Method[] methods = ReflectionUtil.getMethods(annotationType, new Filter<Method>() {
            @Override
        ...
        for (Method method : methods) {
            result.put(method.getName(), ReflectionUtil.invoke(annotation, method));
        }
        return result;
    }
