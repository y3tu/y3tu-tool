...
public class IOUtil {
     ...
     * @param in             输入流
     * @param out            输出流
     * @param bufferSize     缓存大小 小于0就取默认的IOUtil.DEFAULT_BUFFER_SIZE(1024)
     * @param streamProgress 进度条
     * @return 传输的byte数
     * @throws IORuntimeException IO异常
     */
    public static long copy(InputStream in, OutputStream out, int bufferSize, @Nullable StreamProgress streamProgress) throws IORuntimeException {
     ...
     * @throws IORuntimeException IO异常
     */
    public static long copy(Reader reader, Writer writer, int bufferSize, @Nullable StreamProgress streamProgress) throws IORuntimeException {
...
// -------------------------------------------------------------------------------------- getReader and getWriter start
    ...
    public static ByteArrayInputStream toStream(String content, Charset charset) {
        ...
        return new ByteArrayInputStream(StringUtils.bytes(content, charset));
    }
