...
public class VersionComparator implements Comparator<String>, Serializable {
    ...
    public int compare(String version1, String version2) {
        ...
        final List<String> v1s = ListUtil.toList(StringUtils.split(version1, CharUtil.DOT));
        final List<String> v2s = ListUtil.toList(StringUtils.split(version2, CharUtil.DOT));
