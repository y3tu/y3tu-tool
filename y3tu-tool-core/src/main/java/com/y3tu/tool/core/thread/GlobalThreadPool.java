...
public class GlobalThreadPool {
    ...
    synchronized public static void init() {
        ...
        ThreadFactory threadFactory = ThreadUtil.newNamedThreadFactory("GlobalThreadPool", false);
        executor = ExecutorBuilder.create().useSynchronousQueue().setThreadFactory(threadFactory).build();
    }
