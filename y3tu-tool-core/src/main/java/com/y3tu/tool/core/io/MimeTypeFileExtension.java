 ...
 * @date 2018/11/4
 */
public enum MimeTypeFileExtension {
    /**
     * 文件 Mime对应关系
     */
    JPG("image/jpeg", ".jpg"),
    ...
    MimeTypeFileExtension(String mimeType, String fileExtension) {
    ...
    public static String getMimeType(String fileExtension) {
        for (MimeTypeFileExtension mimeTypeFileExtensionEnum : MimeTypeFileExtension.values()) {
