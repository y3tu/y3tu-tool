...
import com.y3tu.tool.core.map.CaseInsensitiveMap;
...
import com.y3tu.tool.core.util.ModifierUtil;
...
public class BeanDesc {
    ...
    private BeanDesc init() {
        for (Field field : ReflectionUtil.getFields(this.beanClass)) {
    ...
    private PropDesc createProp(Field field) {
        ...
        for (Method method : ReflectionUtil.getMethods(this.beanClass)) {
    ...
    public static class PropDesc {
        ...
        public Object getValue(Object bean) {
            if (null != this.getter) {
                return ReflectionUtil.invoke(bean, this.getter);
            } else if (ModifierUtil.isPublic(this.field)) {
                return ReflectionUtil.getFieldValue(bean, this.field);
            }
            return null;
        }
        ...
        public PropDesc setValue(Object bean, Object value) {
            if (null != this.setter) {
                ReflectionUtil.invoke(bean, this.setter, value);
            } else if (ModifierUtil.isPublic(this.field)) {
                ReflectionUtil.setFieldValue(bean, this.field, value);
            }
            return this;
        }
