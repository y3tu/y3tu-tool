...
public class ReflectionUtil {
     ...
     * @param fieldName 字段名
     * @return 字段值
     * @throws ReflectionException 包装IllegalAccessException异常
     */
     ...
     * @throws ReflectionException 包装IllegalAccessException异常
     */
    public static Object getFieldValue(Object obj, Field field) throws ReflectionException {
        ...
        try {
            ...
            throw new ReflectionException(e, "IllegalAccess for {}.{}", obj.getClass(), field.getName());
        }
        return result;
    }
     ...
     * @param field 字段
     * @param value 值，值类型必须与字段类型匹配，不会自动转换对象类型
     * @throws ReflectionException ReflectionException 包装IllegalAccessException异常
     */
    public static void setFieldValue(Object obj, Field field, Object value) throws ReflectionException {
        Assert.notNull(obj);
     ...
     * @param clazz 类名
     * @return 对象
     * @throws ReflectionException 包装各类异常
     */
    @SuppressWarnings("unchecked")
    public static <T> T newInstance(String clazz) throws ReflectionException {
        try {
            ...
            throw new ReflectionException(e, "Instance class [{}] error!", clazz);
        }
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T newInstance(Class<T> clazz, Object... params) throws ReflectionException {
        if (ArrayUtil.isEmpty(params)) {
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                if (LinkedHashSet.class.isAssignableFrom(clazz)) {
                    ...
                    return (T) ListUtil.newArrayList();
                }
            }
     ...
     * @param args   参数对象
     * @return 结果
     * @throws ReflectionException 多种异常包装
     */
    public static <T> T invokeStatic(Method method, Object... args) throws ReflectionException {
     ...
     * @param args   参数对象
     * @return 结果
     * @throws ReflectionException 一些列异常的包装
     */
    public static <T> T invokeWithCheck(Object obj, Method method, Object... args) throws ReflectionException {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T invoke(Object obj, Method method, Object... args) throws ReflectionException {
    ...
    public static <T> T invoke(Object obj, String methodName, Object... args) throws ReflectionException {
        ...
        if (null == method) {
            throw new ReflectionException(StringUtils.format("No such method: [{}]", methodName));
        }
        return invoke(obj, method, args);
    }
}
