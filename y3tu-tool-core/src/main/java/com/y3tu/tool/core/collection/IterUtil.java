...
public class IterUtil {
    ...
    public static <K, V> Map<K, V> fieldValueMap(Iterator<V> iter, String fieldName) {
        ...
        if (null != iter) {
            ...
            while (iter.hasNext()) {
                value = iter.next();
                result.put((K) ReflectionUtil.getFieldValue(value, fieldName), value);
            }
        }
        return result;
    }
    ...
    public static <K, V> Map<K, V> fieldValueAsMap(Iterator<?> iter, String fieldNameForKey, String fieldNameForValue) {
        ...
        if (null != iter) {
            ...
            while (iter.hasNext()) {
                value = iter.next();
                result.put((K) ReflectionUtil.getFieldValue(value, fieldNameForKey), (V) ReflectionUtil.getFieldValue(value, fieldNameForValue));
            }
        }
        return result;
    }
    ...
    public static <V> List<Object> fieldValueList(Iterator<V> iter, String fieldName) {
        ...
        if (null != iter) {
            ...
            while (iter.hasNext()) {
                value = iter.next();
                result.add(ReflectionUtil.getFieldValue(value, fieldName));
            }
        }
        return result;
    }
