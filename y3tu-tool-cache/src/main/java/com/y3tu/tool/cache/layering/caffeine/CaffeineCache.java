...
public class CaffeineCache extends AbstractValueAdaptingCache {
     ...
     * @param stats           是否开启统计模式
     */
    public CaffeineCache(String name, Cache<Object, Object> cache, boolean allowNullValues, boolean stats) {
    ...
    private <T> Object loaderValue(Object key, Callable<T> valueLoader) {
        ...
        try {
            ...
            log.debug("caffeine缓存 key={} 从库加载缓存", JsonUtil.toJson(key), JsonUtil.toJson(t));
